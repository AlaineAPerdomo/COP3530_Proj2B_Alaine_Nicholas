...
class SidebarPanel(QFrame):
    ...
    def __init__(self):
        ...
        algorithm_label.setProperty("surface", "transparent")
        ...
        feature_label.setProperty("surface", "transparent")
        ...
        order_label.setProperty("surface", "transparent")
        ...
        sample_label.setProperty("surface", "transparent")

        sample_row = QWidget()
        sample_row.setProperty("surface", "transparent")
        ...
        knob_column.setProperty("surface", "transparent")
        ...
        min_max_label.setProperty("surface", "transparent")
        ...
        animation_note.setProperty("surface", "transparent")
        ...
        sample_meta_column.setProperty("surface", "transparent")
        ...
        actions_label.setProperty("surface", "transparent")
