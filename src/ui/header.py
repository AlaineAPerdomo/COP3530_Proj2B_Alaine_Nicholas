...
class HeaderPanel(QFrame):
    def __init__(self):
        ...
        chip_row = QWidget()
        chip_row.setProperty("surface", "transparent")
        ...
        legend_row = QWidget()
        legend_row.setProperty("surface", "transparent")
        ...
        legend_title.setProperty("surface", "transparent")
    ...
    def _build_legend_chip(self, color: str, label_text: str) -> QWidget:
        ...
        swatch.setProperty("surface", "transparent")
